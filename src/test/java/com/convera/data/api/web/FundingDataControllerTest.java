...
class FundingDataControllerTest {
  ...
  void shouldGetOrder() throws Exception {
    ...
    when(orderRepository.findById(any()))
        .thenReturn(Optional.of(new Order("NTR297622", "MP-CPL-1", "FUNDED", "USD", now.of(2022, 9, 14, 16, 56, 30),
            now.of(2022, 9, 14, 16, 56, 30), new BigDecimal(34555), new BigDecimal(24000))));
  ...
  void shouldUpdateOrder() throws Exception {
    Order order = new Order("NTR297622", "MP-CPL-1", "Pending", "USD", now.of(2022, 9, 14, 16, 56, 30),
        now.of(2022, 9, 14, 16, 56, 30), new BigDecimal(34555), new BigDecimal(24000));
    ...
    when(orderRepository.save(order)).thenReturn(new Order("NTR297622", "MP-CPL-1", "Funded", "USD",
        now.of(2022, 9, 14, 16, 56, 30), now.of(2022, 9, 14, 16, 56, 30), new BigDecimal(34555), new BigDecimal(3100)));
    this.mockMvc
        .perform(
